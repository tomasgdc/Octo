...
void RecreateAfterSwapchainResize()
{
	...
	/*Recreate pipeline*/
	DOD::Ref vert_ref = Renderer::Resource::GpuProgramManager::GetResourceByName("Assets/Shaders/triangle.vert.spv");
	DOD::Ref frag_ref = Renderer::Resource::GpuProgramManager::GetResourceByName("Assets/Shaders/triangle.frag.spv");
...
int main(int argc, char *argv[])
{
	...
	Renderer::Resource::GpuProgramManager::LoadAndCompileShader(vert_ref, "../../Assets/Shaders/", VK_SHADER_STAGE_VERTEX_BIT);
	Renderer::Resource::GpuProgramManager::LoadAndCompileShader(frag_ref, "../../Assets/Shaders/", VK_SHADER_STAGE_FRAGMENT_BIT);
