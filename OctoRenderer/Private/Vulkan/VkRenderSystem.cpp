			...
			//for
			{
				//DO SOMETHING
				{
					...
					//for (int j = 0; j < listLocalBuffersVerts.size(); j++)
					{
						...
						vkCmdBindDescriptorSets(CommandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, pipeline_layout, 0, 1, &descriptor_set, 0, NULL);
						...
						vkCmdDrawIndexed(CommandBuffer, index_count, 1, 0, 0, 1);
					}
				}
			}
		}
